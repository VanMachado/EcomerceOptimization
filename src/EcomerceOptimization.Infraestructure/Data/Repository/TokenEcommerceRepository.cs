...
{
    public class TokenEcommerceRepository : ITokenEcommerceRepository
    {
        private readonly IUnitOfWork _unitOfWork = null;
        private readonly ILogger<TokenEcommerceRepository> _logger;

        public TokenEcommerceRepository()
        {
        }

        public TokenEcommerceRepository(IUnitOfWork unitOfWork)
        {
